...
const HeaderInfo = () => {
    ...
    const onCityClick = (e: { preventDefault: () => void; }) => {
        e.preventDefault();
    ...
    return (
        <div className='content-info-wrapper'>
            ...
            <div className="header-login">
                <svg onClick={Auth.isAuth ? () => {} : onLoginClick} version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 489 489" enableBackground="new 0 0 489 489">
