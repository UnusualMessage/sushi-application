    ...
    return (
        <div className='content-info-wrapper'>
            ...
            <div className='header-city'>
                ...
                <span className='city-name'>{CitiesStore.getCity()}</span>
            </div>
            ...
            <div className="header-login">
                <svg onClick={AuthStore.getIsAuthenticated() ? () => { } : showLoginModal} version="1.1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 489 489" enableBackground="new 0 0 489 489">
                ...
                {AuthStore.getIsAuthenticated()
                    ?
                        AuthStore.compareWithRole("Courier") 
                        ?
